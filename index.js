...
/*task no 3
let personName:string= "mishal nadeem";
//in lowercase
...
let transport: string []= [" Honda motorcycle","civil","Audi","honda city"];
transportation.map((items) => console.log('I would like to own a ${ items}'));

//task no 14
let guestArr: string []= [" Honey","Usia","Abhi","hamza"];

guestArr.map((items) => ( console.log('Dear ${items} , ou are invited to the Dinner')));
//task no 15
/*let guestArr: string []= [" Mishal","Usia","Abhi","hamza"];
let cannotAttend:string="Abhi"

console.log( cannotAttend + " " "cannot attend the dinner.")

let newguest:string = "sunaina"
...
guestArr.map(function (items) {
    return console.log("Dear ".concat(items, ",I found a bigger table so Iam invited more people."));
});
//part 2
...
// task no 20
let country: string []=["pakistan","India","China","japan","Newyork"]
...
//task no 22
 days: string[]=["Sunday","Monday","Tuesday","Wednessday","thursday","friday","saturday"]
 console.log(days{7})
console.log(days[6])
//task no 23
let car = "subaru";
